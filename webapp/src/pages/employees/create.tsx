...
import { create, getAllShifts, getAllRoles } from "../../services/employees"
...
export const CreateEmployee = () => {
  ...
  useEffect(() => {
    setForm(form => ({
      ...form,
      cityId: cities ? cities[0].id : 0,
      condominiumId: condominiums ? condominiums[0].id : 0,
      shiftId: shifts ? shifts[0].id : 0,
      roleId: roles ? roles[0].id : 0,
    }))
  }, [cities, condominiums, shifts, roles])
